...
if __name__ == "__main__":
    ...
    feedback_file = f"./cleaned_data/qwen110b/feedbacks/testable_{src_lang}_{dst_lang}_w_{test_case_num}cases_{_round}round.jsonl"
    # 第N-1轮作为原始结果
    org_sol_file = f"./cleaned_data/qwen110b/post_processed_w_{test_case_num}cases_{_round}round/testable_{src_lang}_{dst_lang}_w_{test_case_num}cases_{_round}round.jsonl"
    # todo not adapt for gen_val_inp yet
    # 第N轮refine输出
    out_path = f"./cleaned_data/qwen110b/testable_{src_lang}_{dst_lang}_w_{test_case_num}cases_{_round}round.jsonl"
...
# python qwen110b.py --src_lang java --dst_lang cpp --obj 2 --k 10 --test_case_num 0
# python qwen110b.py --src_lang java --dst_lang cpp --obj 0 --k 10 --test_case_num 20