...
if __name__ == "__main__":
    ...
    file_path = f"./cleaned_data/{model}/testable_{src_lang}_{dst_lang}{suffix}.jsonl"
    gold_file_path = f"./cleaned_data/testable_samples.jsonl"

    evaluation_em()
    #python test_EM.py --model llama7b --src_lang java --dst_lang cpp --suffix _w_0cases_2round
